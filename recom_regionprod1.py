...
newdf1 = df[(df.Region == 'South')][(df.Product == 'A')]
print(len(newdf1))
newdf2 = df[(df.Region == 'South')][(df.Product == 'B')]
newdf3 = df[(df.Region == 'South')][(df.Product == 'C')]
newdf4 = df[(df.Region == 'South')][(df.Product == 'D')]
newdf5 = df[(df.Region == 'South')][(df.Product == 'E')]
newdf6 = df[(df.Region == 'South')][(df.Product == 'F')]
newdf7 = df[(df.Region == 'South')][(df.Product == 'G')]
print(len(newdf2))
print(len(newdf3))
print(len(newdf4))
print(len(newdf5))
...
df.to_csv('file7.csv')
plt.title("Most Popular Product in South Region")
plt.show()
