...
newdf1 = df[(df.Region == 'North')][(df.Product == 'A')]
print(len(newdf1))
newdf2 = df[(df.Region == 'North')][(df.Product == 'B')]
newdf3 = df[(df.Region == 'North')][(df.Product == 'C')]
newdf4 = df[(df.Region == 'North')][(df.Product == 'D')]
newdf5 = df[(df.Region == 'North')][(df.Product == 'E')]
newdf6 = df[(df.Region == 'North')][(df.Product == 'F')]
newdf7 = df[(df.Region == 'North')][(df.Product == 'G')]
print(len(newdf2))
print(len(newdf3))
print(len(newdf4))
print(len(newdf5))
...
df.to_csv('file8.csv')
plt.title("Most Popular Product in North region")
plt.show()
